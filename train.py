...
if __name__ == '__main__':
    ...
    config_type= 'complete_all'#sys.argv[1]#'complete' #'low_utilization' # slow_server, n_system, low_utilization, high_utilization
    reward_function = 'cycle_time'
    time_steps = 1000000#sys.argv[2]
    n_steps = 2048#sys.argv[3]
    # Create log dir
    log_dir = f"./tmp_gamma/{reward_function}_{config_type}_{time_steps}_{n_steps}/"
