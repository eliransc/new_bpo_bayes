...
def aggregate_sims(a1, a2, a3, a4, a5, a6, a7):
    ...
    for ind in range(1):
        ...
        print(res)
        tot_res.append(res)
        pkl.dump(tot_res, open('opt_2_complete_reversed' + str(model_num) + '.pkl', 'wb'))
...
def main():
    ...
    complete_parallel = [16.25241923304227, 12.250521336587763, 14.43510634863599, 5.837521363412663, 18.35548245025887, 14.291515667953812, 377.12721840056307]
    # simulate_competition(A)

    get_results = aggregate_sims(15.42641286533492, 0.41503898718803, 12.672964698525508, 14.976077650772236, 9.970140246051809, 4.495932910616953, 1459.9031432379812)
