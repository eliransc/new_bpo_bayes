...
def simulate_competition(A):
    ...
    simulator_fake = Simulator(running_time, ShortestProcessingTime(), config_type='parallel', reward_function='AUC')
    a1 = A[0]
    a2 = A[1]
    a3 = A[2]
    a4 = A[3]
    ...
    simulator = Simulator(running_time, planner, config_type='parallel', reward_function='AUC')
...
def aggregate_sims(a1, a2, a3, a4, a5, a6, a7):
    ...
    pkl.dump((a1, a2, a3, a4, a5, a6, a7, tot_res), open('single_bayes_' + 'parallel' + str(model_num) + '.pkl', 'wb'))
