...
def simulate_competition(A):
    ...
    simulator_fake = Simulator(running_time, ShortestProcessingTime(), config_type='simple_linear_low_utilisation', reward_function='AUC')
    a1 = A[0]
    a2 = A[1]
    a3 = A[2]
    a4 = A[3]
    ...
    simulator = Simulator(running_time, planner, config_type='simple_linear_low_utilisation', reward_function='AUC')
