...
def simulate_competition(A):
    ...
    simulator_fake = Simulator(running_time, ShortestProcessingTime(), config_type='simple_linear_high_utilisation3', reward_function='AUC')
    a1 = A[0]
    a2 = A[1]
    a3 = A[2]
    a4 = A[3]
    ...
    planner = Bayes_planner(a1, a2, a3, a4, a5, a6, simulator_fake) # ShortestProcessingTime() # Insert your planner here, input can be the parameters of your model
    planner1 = ShortestProcessingTime()

    # The config types dictates the system
    simulator = Simulator(running_time, planner, config_type='simple_linear_high_utilisation3', reward_function='AUC')
...
def aggregate_sims(A):
    ...
    for ind in range(5):
        ...
        tot_res.append(res)
        pkl.dump(tot_res, open('res_simple_linear_high_utilisation3_'+ str(model_num) + '.pkl', 'wb'))
